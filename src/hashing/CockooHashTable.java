 ...
 * @time 2018/8/21 16:57
 * @project DataStructurelearning-basis
 * @Version 1.0.0
 */
public class CockooHashTable <AnyType> {
    /**
     * Construct the hash table.
     *
     * @param hf the hash family
     */
    public CockooHashTable(HashFamily<? super AnyType> hf) {
     ...
     */
    public CockooHashTable(HashFamily<? super AnyType> hf, int size) {
    ...
    public static void main(String[] args) {
        ...
        for (int att = 0; att < ATTEMPTS; att++) {
            ...
            CockooHashTable<String> H = new CockooHashTable<>(new StringHashFamily(3));
